...
import com.example.powerpuffgirlsuser.dummy.DummyContent;
...
public class UserProfileDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.userprofile_detail, container, false);

        // Show the dummy content as text in a TextView.
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.userprofile_detail)).setText(mItem.details);
        }
